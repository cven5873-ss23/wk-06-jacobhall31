...
For this analysis we will use the jmpwashdata R Package [@jmpwashdata]. The package contains all data compiled by the [WHO/UNICEF Joint Monitoring Programme (JMP)](https://washdata.org).
